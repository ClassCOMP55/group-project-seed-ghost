...
public class SKILL_Explode extends Skill {
	...
	public void activationEffect (Entity me, Entity target) {
		...
		dmg[DamageType.BLAST.ordinal()] = 10 * Chance.softExponential(1.02, scaling, 1000, 1.4);
		dmg[DamageType.FIRE.ordinal()] = 10 * Chance.softExponential(1.02, scaling, 1000, 1.4);
	...
	public String getEnemyIntentMsg(Entity me, Entity target) {
		int scaling = (int)Math.round(me.getStatSpread()[EntityStats.ARC.ordinal()]*0.6 + me.getStatSpread()[EntityStats.CON.ordinal()]*0.4);
		return "Intends to violently self-detonate for " + (int)(20 * Chance.softExponential(1.02, scaling, 1000, 1.4)) + " damage!";
	}
}
