...
public class SKILL_CriticalShot extends Skill {
	...
	public void activationEffect (Entity me, Entity target) {
		...
		double damage = 10 * Chance.softExponential(1.07, scaling, 3000, 1.15);
	...
	public String getEnemyIntentMsg(Entity me, Entity target) {
		int scaling = (int)Math.round(me.getStatSpread()[EntityStats.PRC.ordinal()]*0.7 + me.getStatSpread()[EntityStats.DEX.ordinal()] * 0.3);
		return "Intends to shoot the " + target + " for " + (int)((Character)target).calculateDamage(10 * Chance.softExponential(1.07, scaling, 3000, 1.15), DamageType.PIERCE) + " damage!";
	}
}
